...
const assignments: Assignment[] = [
  { 
    ...
    preview: '/assignments/docs/Choose the best OS.pdf',
    ...
    metadata: [
      { label: 'Format', value: 'PDF Preview' },
  ...
  { 
    ...
    preview: '/assignments/docs/Integrating Information Technology in Different Industries.pdf',
  ...
  { 
    ...
    preview: '/assignments/docs/Reflection on Device Teardowns_ MacBook Pro (M4) and iPad Pro 13_.pdf',
  ...
  { 
    ...
    preview: '/assignments/docs/Juveniles and Cybercrime.pdf',
  ...
  { 
    ...
    preview: '/assignments/docs/SQL.pdf',
